/* V5.2 reviewed battle roster metadata plus the user-provided Goose OC. */
(function (V4) {
  'use strict';
  const reviewed={
  ...
  if(!(V4.database.characters||[]).some(character=>character.id==='goose-eclipsed-goddess')) V4.database.characters.push({
    id:'goose-eclipsed-goddess',name:'Goddess',displayTitles:['The Eclipse Goddess','Abyssal Saint'],source:'fan',creatorLabel:'User OC',spoilerEra:'wano-end',referenceTier:'legendary',affiliations:[],roles:['anomaly','combatant'],encounterTags:['wild-card','alternate-world','mythical-zoan','gravity'],combatProfileId:'combat-goose-eclipsed-goddess',mentorProfileId:null,fruitId:'tori-tori-no-mi-model-lunar-abyssal-goose-goddess',weaponIds:[],foundationIds:['basic-martial-arts'],disciplineIds:[],techniqueIds:[],advancedStateIds:['goose-full-alter','goose-ishtar-pact'],hakiProfile:{observation:true,armament:true,conquerors:true,advancedObservation:true,advancedArmament:true,conquerorsCoating:false},relationshipIds:[],factionRank:null,bountyHistory:[],notes:['Appears 18; female, she/her.','A reincarnated alternate-world anomaly whose public bounty begins at zero until her abilities are witnessed.','Cold, arrogant, curious, and dramatically goddess-like; seeks to understand or eclipse the world’s order.'],appearance:{hair:'Long silver twin-tails with dark violet streaks and faint golden cracks',eyes:'Orange, shifting to violet eclipse under power',attire:'Black-violet sailor uniform, gold accents, and a distorted moonlight haori'},soulBoundPacts:[{id:'goose-ishtar-pact',name:'Ishtar Pact',source:'fan',description:'Divine-authority and gem-magecraft influence fused with gravity control.'},{id:'goose-full-alter',name:'Full Alter Mode',source:'fan',description:'A colder black-violet inversion that raises destructive output and ruthlessness.'}],goal:'Understand the world, master her awakened power, and decide whether to eclipse its order or carve out her own domain.'
  });
